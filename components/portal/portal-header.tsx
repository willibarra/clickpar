...
export function PortalNav() {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-border/50 bg-background/95 backdrop-blur-xl sm:sticky sm:top-16 sm:border-t-0 sm:border-b sm:border-border/50 sm:bg-background/80 sm:backdrop-blur-xl" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
