...
export default async function NuevoProveedorPage() {
    ...
    async function handleCreate(formData: FormData) {
        ...
        if (result.error) {
            // We'll redirect with an error param (simple approach)
            redirect(`/proveedores/nuevo?error=${encodeURIComponent(result.error)}`);
        }
        ...
        <div className="space-y-6 max-w-xl">
            ...
            <div>
                ...
                <p className="text-sm mt-0.5" style={{ color: '#8b8ba7' }}>
                    Registrá un nuevo proveedor de cuentas
                </p>
            </div>
